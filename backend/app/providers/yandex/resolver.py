...
class YandexLocationResolver:
    ...
    def startup_diagnostics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "body_preview": client_diagnostics.get("body_preview"),
            "response_final_host": client_diagnostics.get("response_final_host"),
            "response_final_path": client_diagnostics.get("response_final_path"),
            "redirect_history_status_codes": client_diagnostics.get("redirect_history_status_codes"),
            "redirect_history_hosts": client_diagnostics.get("redirect_history_hosts"),
            "server_header": client_diagnostics.get("server_header"),
            "location_header": client_diagnostics.get("location_header"),
