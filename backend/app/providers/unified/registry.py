...
class ProviderRegistry:
    ...
    def register(self, provider: TransportProvider, *, id: str, name: str, priority: int, enabled: bool = True, capabilities: ProviderCapabilities) -> ProviderRegistration:
        registration = ProviderRegistration(id=id, name=name, priority=priority, enabled=enabled, capabilities=capabilities)
